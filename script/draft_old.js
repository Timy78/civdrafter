...
function pushCells(maxCells, columns){
  if(maxCells != civilizations){
    ...
    for(i=0; i<cellsToPush; i++){
      ...
      '<div class="cell"><div class="item item-empty"><input type="checkbox" value="" class="item_checkbox" disabled><div class="bg_icon_empty"><assets src="" alt=""class="leader_icon"></div><span class="leader_name"></span></div></div>');
    };
  };
...
function startingDraft(){
  ...
  function draftTableCreate(){
    ...
    playerBlockNationItem.innerHTML = '<assets src="" alt=""><span>1</span>';
    ...
    for(k=0; k < players; k++){
      ...
      for(i=0; i<nationsPerPlayer; i++){
        ...
        let imgLink = 'assets/nations/'+ nationAbb +'.png';
        let str;
